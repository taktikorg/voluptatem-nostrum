# @taktikorg/voluptatem-nostrum

> forked from [@taktikorg/voluptatem-nostrumode](https://www.npmjs.com/package/@taktikorg/voluptatem-nostrumode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@taktikorg/voluptatem-nostrumode/issues/300).

[![npm version](https://img.shields.io/npm/v/@taktikorg/voluptatem-nostrum.svg)](https://www.npmjs.com/package/@taktikorg/voluptatem-nostrum)
[![Downloads](https://img.shields.io/npm/dm/@taktikorg/voluptatem-nostrum.svg)](https://www.npmjs.com/package/@taktikorg/voluptatem-nostrum)
[![Build Status](https://github.com/taktikorg/voluptatem-nostrum/workflows/CI/badge.svg)](https://github.com/taktikorg/voluptatem-nostrum/actions)
...
```sh
npm install --save-dev eslint @taktikorg/voluptatem-nostrum
```
...
```js
const nodePlugin = require("@taktikorg/voluptatem-nostrum")
...
💼 [Configurations](https://github.com/taktikorg/voluptatem-nostrum#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/taktikorg/voluptatem-nostrum#-configs).\
...
`@taktikorg/voluptatem-nostrum` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/taktikorg/voluptatem-nostrum/releases)
